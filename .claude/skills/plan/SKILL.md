...
Before doing anything else, check whether the user has given enough detail to understand **what** they want to build. A bare invocation like `/plan` with no description, or a one-word topic, is not enough.
